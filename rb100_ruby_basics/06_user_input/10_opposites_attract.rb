...
# be positive, and one negative; however, the order in which the two integers are
# entered does not matter. Do not check for the positive/negative requirement
...
def read_number
  loop do
    puts ">> Please enter a positive, then a negative number (or vice versa):"
    number = gets.chomp
